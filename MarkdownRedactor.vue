...
<script>
import ImageUploader from "@sergtyapkin/image-uploader";
import DragNDropLoader from "./DragNDropLoader.vue";

const IMAGE_MAX_RES = 1920; // px
...
export default {
  ...
  data() {
    return {
      ...
      ImageUploader: new ImageUploader(this.$popups, this.uploadFunction, this.cropSize, this.compressSize),
